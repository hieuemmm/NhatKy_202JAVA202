...
//  * JComponent dùng để vẽ số dòng. JComponent này nên được thêm vào dưới dạng xem tiêu đề hàng trong 
//JScrollPane. Dựa trên LineNumberModel được cung cấp, thành phần này sẽ vẽ các số dòng dưới dạng
//  * cần thiết.
...
public class LineNumberComponent extends JComponent {
    ...
    // đệm pixel ở bên trái và bên phải
