...
public class FormNhatKy extends javax.swing.JFrame {
    ...
    public final ThuMucController thumucServices;
    public final NhatKyController nhatkyServices;
    ...
    public FormNhatKy(NguoiDung nguoidung) throws ClassNotFoundException, SQLException, UnsupportedLookAndFeelException, InstantiationException, IllegalAccessException {
        ...
        NK = new NhatKy();
        TM.setMaThuMuc(1);
        thumucServices = new ThuMucController();
        nhatkyServices = new NhatKyController();
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, 1183, Short.MAX_VALUE)
                .addContainerGap())
        );
